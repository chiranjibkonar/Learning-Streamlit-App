...
st.markdown("<div style='text-align: right;'> Bose was born in Calcutta (now Kolkata), the eldest of seven children \
...
Bose, Sarada Prasanna Das, and Prafulla Chandra Ray. </div>", unsafe_allow_html=True) 
